...
let joinCheck = await findUser(ctx)
  if(joinCheck){
    ...
    await ctx.replyWithMarkdown('🅿️ Follow our [Instagram](https://instagram.com/i_amrudra)\n\n🅿️ Like All the Reels\n\n🅿️ And Comment `Good`\n\n⏩ Send Your Instagram Link to me', { disable_web_page_preview: true, reply_markup: { remove_keyboard: true } })
 } else {
...
bot.hears('✅ Done', async (ctx) => {
	ctx.scene.leave();
	await ctx.replyWithMarkdown('🅿️ Subscribe our sponsor [Youtube](https://youtube.com/channel/UCdYMvnmu0YnNFl_V6Db1L_w)\n\n🅿️ Like and Comment `Good Project` On This [Video](https://youtube.com/channel/UCdYMvnmu0YnNFl_V6Db1L_w)\n\n🅿️ Like All Video Also\n\n⏩ Send Your Youtube Link to me',{disable_web_page_preview:true,reply_markup: { remove_keyboard: true } })
...
fbhandle.on('text', async (ctx) => {
	ctx.scene.leave();
  var ppc = `🔹 Join our Sponser Telegram [Channel](t.me/AirdropRankers).
